    ...
    public class ServisController : ApiController
    {
        ...
        public List<OgretmenModel> OgretmenListe()
        {
            List<OgretmenModel> liste = db.Ogretmen.Select(x => new OgretmenModel()
            {
                ...
                ogretmenBolumu = x.Ders.dersAdi,
                ogretmenBolumKodu = x.Ders.dersKodu,
        ...
        public SonucModel OgrenciDuzenle(OgrenciModel model)
        {
            ...
            kayit.ogrAdmin = model.ogrAdmin;
            kayit.ogrEmail = model.ogrEmail;
        ...
        public List<OdevModel> OdevListe()
        {
            List<OdevModel> liste = db.Odev.Select(x => new OdevModel()
            {
                ...
                odevDersKredi = x.Ders.dersKredi,
                odevDersKodu = x.Ders.dersKodu
            }).ToList();
            return liste;
        }
        [HttpGet]
        ...
        public List<KayitModel> OgrenciOdevListe(string ogrId)
        {
            List<KayitModel> liste = db.Kayit.Where(s => s.kayitOgrId == ogrId).Select(x => new KayitModel()
            {
                ...
                kayitTeslimTarih =x.kayitTeslimTarih,
        ...
        [HttpGet]
        [Route("api/ogretmenodevliste/{ogretmenId}")] 
        public List<KayitModel> OdevOgrencisListe(string ogretmenId) 
        {
            List<KayitModel> liste = db.Kayit.Where(s => s.kayitOgretmenId == ogretmenId).Select(x => new KayitModel()
            {
                kayitId = x.kayitId,
                kayitOdevId = x.kayitOdevId,
                kayitOgrId = x.kayitOgrId,
        ...
        public List<KayitModel> OgretmenOdevListe(string odevId)
        {
        ...
        public SonucModel KayitEkle(KayitModel model)
        {
            ...
            yeni.kayitTeslimTarih = model.kayitTeslimTarih;
